...
A list of n=30 VCF files is used as input. These VCF files were generated
...
`mutSignatures`, `dplyr`, `ggplot2`, `BSgenome.Hsapiens.UCSC.hg19`, and `kableExtra`.
...
blca_params <- setMutClusterParams( 
    num_processesToExtract = 8,       # num signatures to extract
...
msigPlot(my_sigs_1, signature = 6, ylim = c(0, 0.15))
msigPlot(my_sigs_1, signature = 3, ylim = c(0, 0.15))

par(mfrow = c(4, 1)) 
msigPlot(my_sigs_1, signature = 1, ylim = c(0, 0.15))
msigPlot(my_sigs_1, signature = 2, ylim = c(0, 0.15))
msigPlot(my_sigs_1, signature = 3, ylim = c(0, 0.15))
msigPlot(my_sigs_1, signature = 4, ylim = c(0, 0.15))

par(mfrow = c(4, 1)) 
msigPlot(my_sigs_1, signature = 5, ylim = c(0, 0.15))
msigPlot(my_sigs_1, signature = 6, ylim = c(0, 0.15))
msigPlot(my_sigs_1, signature = 7, ylim = c(0, 0.15))
msigPlot(my_sigs_1, signature = 8, ylim = c(0, 0.15))


msigPlot(my_sigs_1, signature = 1)
msigPlot(my_sigs_1, signature = 1)
msigPlot(my_sigs_1, signature = 1)
